...
export const RANKS: RankMeta[] = [
  ...
  { id:'bronze1',   label:'Bronze I',     icon:'🪨', tier:1,  color:'#3d1a06', glow:'#a05228', border:'#5c2b08', minScore:0.005,  maxScore:0.08  },
  { id:'bronze2',   label:'Bronze II',    icon:'🥉', tier:2,  color:'#5c2b08', glow:'#c46820', border:'#7a3c10', minScore:0.08,   maxScore:0.18  },
  { id:'bronze3',   label:'Bronze III',   icon:'🪙', tier:3,  color:'#7a3c10', glow:'#e07830', border:'#9a5218', minScore:0.18,   maxScore:0.30  },
  { id:'silver1',   label:'Silver I',     icon:'🔘', tier:4,  color:'#28283c', glow:'#8888a8', border:'#3c3c50', minScore:0.30,   maxScore:0.45  },
  { id:'silver2',   label:'Silver II',    icon:'⚪', tier:5,  color:'#3c3c52', glow:'#a0a0c0', border:'#505068', minScore:0.45,   maxScore:0.62  },
  { id:'silver3',   label:'Silver III',   icon:'🌙', tier:6,  color:'#50506a', glow:'#c0c0d8', border:'#68687e', minScore:0.62,   maxScore:0.82  },
  { id:'gold1',     label:'Gold I',       icon:'⭐', tier:7,  color:'#3a2e00', glow:'#c09000', border:'#5a4800', minScore:0.82,   maxScore:1.05  },
  { id:'gold2',     label:'Gold II',      icon:'🌟', tier:8,  color:'#5a4800', glow:'#d8b000', border:'#7a6200', minScore:1.05,   maxScore:1.32  },
  { id:'gold3',     label:'Gold III',     icon:'👑', tier:9,  color:'#7a6200', glow:'#f0cc00', border:'#a08400', minScore:1.32,   maxScore:1.65  },
  { id:'platinum1', label:'Platinum I',   icon:'🔵', tier:10, color:'#08304a', glow:'#50a8d8', border:'#0e4868', minScore:1.65,   maxScore:2.05  },
  { id:'platinum2', label:'Platinum II',  icon:'💎', tier:11, color:'#0e4868', glow:'#68c0f0', border:'#186488', minScore:2.05,   maxScore:2.52  },
  { id:'platinum3', label:'Platinum III', icon:'🩵', tier:12, color:'#186488', glow:'#88d8ff', border:'#2480aa', minScore:2.52,   maxScore:3.08  },
  { id:'diamond1',  label:'Diamond I',    icon:'💠', tier:13, color:'#0a1060', glow:'#4466ee', border:'#142088', minScore:3.08,   maxScore:3.72  },
  { id:'diamond2',  label:'Diamond II',   icon:'🔷', tier:14, color:'#142088', glow:'#5588ff', border:'#2038b0', minScore:3.72,   maxScore:4.45  },
  { id:'diamond3',  label:'Diamond III',  icon:'✦',  tier:15, color:'#2038b0', glow:'#80aaff', border:'#3058dd', minScore:4.45,   maxScore:5.30  },
  { id:'elite',     label:'Elite',        icon:'🔮', tier:16, color:'#38086a', glow:'#cc44ff', border:'#5010a0', minScore:5.30,   maxScore:6.25  },
  { id:'champion',  label:'Champion',     icon:'🔴', tier:17, color:'#6a0818', glow:'#ff2244', border:'#9a1020', minScore:6.25,   maxScore:7.40  },
  { id:'god',       label:'God',          icon:'☀️', tier:18, color:'#6a2800', glow:'#ff8800', border:'#a04000', minScore:7.40,   maxScore:Infinity },
]
